// MAPID API Key â€” hardcoded for competition use
...
export const BASEMAP_STYLES: Record<string, string> = {
  ...
  street: `https://p2basemap.mapid.io/styles/street/style.json?key=${MAPID_KEY}`,

  // Dark mode
  dark: `https://p2basemap.mapid.io/styles/dark/style.json?key=${MAPID_KEY}`,

  // Satellite
  satellite: `https://p2basemap.mapid.io/styles/satellite/style.json?key=${MAPID_KEY}`,
};
